...
class ViajeControllerTest {
        ...
        @Test
        void iniciarViaje_ok_autenticado() throws Exception {
        autenticar("driver@compicar.com");

        ViajeDTO viajeIniciado = new ViajeDTO(
                1L,
                LocalDateTime.of(2026, 5, 10, 9, 0),
                "EN_CURSO",
                3,
        ...
        when(viajeRouterService.iniciarViaje("driver@compicar.com", "sevilla-cadiz-2026-05-10"))
                .thenReturn(viajeIniciado);

        mockMvc.perform(put("/api/viajes/sevilla-cadiz-2026-05-10/iniciar"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.estado").value("EN_CURSO"));

        verify(viajeRouterService).iniciarViaje("driver@compicar.com", "sevilla-cadiz-2026-05-10");
        }

        @Test
        void iniciarViaje_noAutenticado_401() throws Exception {
        SecurityContextHolder.clearContext();

        mockMvc.perform(put("/api/viajes/slug-test/iniciar"))
                .andExpect(status().isUnauthorized());
        ...
        @Test
        void iniciarViaje_errorServicio_400() throws Exception {
        autenticar("driver@compicar.com");
        when(viajeRouterService.iniciarViaje("driver@compicar.com", "viaje-pendiente"))
                .thenThrow(new ResponseStatusException(HttpStatus.BAD_REQUEST, "No se puede iniciar el viaje antes de tiempo"));

        mockMvc.perform(put("/api/viajes/viaje-pendiente/iniciar"))
                .andExpect(status().isBadRequest());
        }

        @Test
        void confirmarCheckin_ok_autenticado() throws Exception {
        autenticar("passenger@compicar.com");

        ViajeDTO viajeCheckin = new ViajeDTO(
                1L,
                LocalDateTime.of(2026, 5, 10, 9, 0),
                "EN_CURSO",
                3,
        ...
        when(viajeRouterService.confirmarCheckin("passenger@compicar.com", "sevilla-cadiz-2026-05-10", "checkin789"))
                .thenReturn(viajeCheckin);

        mockMvc.perform(put("/api/viajes/sevilla-cadiz-2026-05-10/checkin")
                .param("checkin", "checkin789"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.id").value(1));

        verify(viajeRouterService).confirmarCheckin("passenger@compicar.com", "sevilla-cadiz-2026-05-10", "checkin789");
        }

        @Test
        void confirmarCheckin_codigoInvalido_400() throws Exception {
        autenticar("passenger@compicar.com");
        when(viajeRouterService.confirmarCheckin("passenger@compicar.com", "sevilla-cadiz-2026-05-10", "codigo-erroneo"))
                .thenThrow(new ResponseStatusException(HttpStatus.BAD_REQUEST, "Código de checkin incorrecto"));

        mockMvc.perform(put("/api/viajes/sevilla-cadiz-2026-05-10/checkin")
                .param("checkin", "codigo-erroneo"))
                .andExpect(status().isBadRequest());
        }

        @Test
        void obtenerProximoViaje_existeViaje_200() throws Exception {
        ViajeDTO proximo = new ViajeDTO(
                1L,
                LocalDateTime.of(2026, 5, 10, 9, 0),
                "PENDIENTE",
                3,
        ...
        when(viajeService.obtenerProximoViajeUsuario("driver@compicar.com")).thenReturn(proximo);
        ...
        mockMvc.perform(get("/api/viajes/proximo")
                ...
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.slug").value("sevilla-cadiz-2026-05-10"));
        }

        @Test
        void obtenerProximoViaje_sinViaje_204() throws Exception {
        when(viajeService.obtenerProximoViajeUsuario("driver@compicar.com")).thenReturn(null);
        ...
        when(viajeService.ponerEnCursoAutomatico("driver@compicar.com", "sevilla-cadiz-2026-05-10"))
                .thenReturn(enCurso);

        mockMvc.perform(put("/api/viajes/sevilla-cadiz-2026-05-10/en-curso")
                .principal(new org.springframework.security.authentication.TestingAuthenticationToken("driver@compicar.com", null)))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.estado").value("EN_CURSO"));
        }
